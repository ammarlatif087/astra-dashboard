...
import 'package:astra_dashboard/src/core/constant/app_theme_color.dart';
...
import 'package:astra_dashboard/src/features/register/register_page.dart';
...
class AdminDashboardApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var kRouter = GoRouter(
      ...
      initialLocation:
          authProvider.isLoggedIn ? AppRoutes.dashboard : AppRoutes.login,
      redirect: (state) {
    ...
    return MultiProvider(
      providers: [
        ChangeNotifierProvider(create: (c) => AppMenuController()),
      ],
      child: OKToast(
