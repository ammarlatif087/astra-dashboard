...
import 'package:astra_dashboard/src/features/customer/data/customer_model.dart';
import 'package:astra_dashboard/src/shared/widgets/common/tag.dart';
...
class _CustomerPageState extends State<CustomerPage>
  ...
  FutureManager<List<CustomerModel>> customerManager =
  ...
  Future fetchData() async {
    customerManager.execute(
      () async {
        ...
        infoLog(
            "Fetch data on page: $page, data: ${list.length}, Total: $total");
