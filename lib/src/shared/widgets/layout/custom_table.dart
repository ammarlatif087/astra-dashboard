...
import 'package:astra_dashboard/src/features/root/root_page.dart';
import 'package:astra_dashboard/src/features/root/widgets/side_menu_layout.dart';
import 'package:astra_dashboard/src/shared/widgets/container/pager.dart';
...
class _MyCustomDataTableState<T extends Object>
    extends State<MyCustomDataTable<T>> {
  List<int> get _dummyRowList =>
      List.generate(widget.data.length, (index) => index);
  List<int> get _dummyColumnList =>
  ...
  double get getTableWidth {
    ...
    return (hasSideMenu ? (screenWidth - SideMenuLayout.width) : screenWidth) -
        somePadding;
  }
                  ...
                  builder: (context, constraint) {
                    if (tableSize.value == null) {
                      WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
                        RenderBox box = tableKey.currentContext!
  ...
  Widget _buildActionButton(int rowIndex) {
    return Column(
      children: [
        ...
        if (rowIndex != _dummyRowList.last)
