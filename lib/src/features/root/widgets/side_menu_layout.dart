...
import 'package:astra_dashboard/src/features/root/data/menu_model.dart';
...
class _MenuList extends StatelessWidget {
  ...
  void onNavigate(BuildContext context, MenuModel menu) {
    readProvider<AppMenuController>(context).menuIndex = menu.index;
  ...
  @override
  Widget build(BuildContext context) {
    final menuController = watchProvider<AppMenuController>(context);
    String location = GoRouter.of(context).location.split("/").last;
    return Column(
      children: kMenuList.map((menu) {
        if (menu.children != null) {
          List<String> children =
              menu.children!.map((e) => e.title.toLowerCase()).toList();
