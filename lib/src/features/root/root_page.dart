...
import 'package:astra_dashboard/src/core/provider/index.dart';
import 'package:astra_dashboard/src/core/provider/menu_controller.dart';
import 'package:astra_dashboard/src/core/router/main_router.dart';
import 'package:astra_dashboard/src/features/customer/customer_page.dart';
import 'package:astra_dashboard/src/features/inventory/inventory_page.dart';
import 'package:astra_dashboard/src/features/product-detail/product_detail_page.dart';
import 'package:astra_dashboard/src/shared/widgets/container/body_layout_container.dart';
...
class RootPage extends StatefulWidget {
  ...
  const RootPage(
      {Key? key, this.mainPageKey = AppRoutes.dashboard, this.subroute})
      : super(key: key);
...
class _RootPageState extends State<RootPage> {
  ...
  late AppMenuController menuController =
      readProvider<AppMenuController>(context);
                  ...
                  builder: (context) {
                    return PageView.builder(
                      ...
                      itemBuilder: (context, index) {
                        Widget child =
                            pages[widget.mainPageKey] ?? emptySizedBox;
